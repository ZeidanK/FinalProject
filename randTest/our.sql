...
(
  id                     BIGINT                                                                                                                                                                                                                                   NOT NULL IDENTITY(1,1),
  company_id             BIGINT                                                                                                                                                                                                                                   NOT NULL,
  anomaly_type           ENUM(duplicate_transaction,duplicate_invoice,amount_mismatch,missing_invoice,missing_transaction,date_discrepancy,unusual_amount,vat_calculation_error,vendor_mismatch,unmatched_for_long_time,low_confidence,currency_conversion,other) NOT NULL,
  ...
  detection_method       ENUM(ai,rule_engine,manual,system)                                                                                                                                                                                                       NOT NULL DEFAULT ai,
...
(
  ...
  user_id     BIGINT                                                                                                                         ,
  company_id  BIGINT                                                                                                                         ,
  action      ENUM(create,read,update,delete,login,logout,permission_change,upload,import,export,match,unmatch,verify,resolve_anomaly,system) NOT NULL,
...
(
  ...
  upload_purpose      ENUM(invoice,transaction,document,profile,other)    NOT NULL,
  related_entity_type VARCHAR(50)                                        ,
  related_entity_id   BIGINT                                             ,
  status              ENUM(uploading,uploaded,processing,completed,error) NOT NULL DEFAULT uploaded,
  created_at          TIMESTAMP                                           NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(
  ...
  match_method         ENUM(ai_automatic,ai_suggested,manual,rule_based)  NOT NULL,
...
(
  ...
  status              ENUM(pending,confirmed,disputed) NOT NULL DEFAULT confirmed,
  notes               TEXT                            ,
...
(
  ...
  user_id            BIGINT                               NOT NULL,
  company_id         BIGINT                               NOT NULL,
  access_level       ENUM(full_access,view_only)          NOT NULL DEFAULT view_only,
...
(
  ...
  match_suggestions BOOLEAN   NOT NULL DEFAULT TRUE,
