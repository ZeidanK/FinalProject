...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'FP26_users' AND COLUMN_NAME = 'website')
    ALTER TABLE dbo.FP26_users ADD website NVARCHAR(500) NULL;
GO
